...
{
    { NV_FALSE,  20, NV_TRUE, 0x8, NvOdmQuerySdioSlotUsage_wlan   },
    { NV_FALSE,  0, NV_FALSE, 0x0, NvOdmQuerySdioSlotUsage_unused  },
    { NV_TRUE,  20, NV_FALSE, 0x0, NvOdmQuerySdioSlotUsage_Media },
    { NV_FALSE, 20, NV_FALSE, 0x0, NvOdmQuerySdioSlotUsage_Boot  }
};
...
static NvOdmWakeupPadInfo s_NvOdmWakeupPadInfo[] =
{
    ...
    {NV_FALSE,  1, NvOdmWakeupPadPolarity_High},    // Wake Event  1 - gp3_pv[3] (.ACOK)
    ...
    {NV_TRUE,   5, NvOdmWakeupPadPolarity_Low},     // Wake Event  5 - vgp[6] (.INT_2_HOST#)
...
//    {NV_FALSE, 23, NvOdmWakeupPadPolarity_Low},     // Wake Event 23 - gmi_iordy (HSMMC_CLK)
    ...
    {NV_FALSE, 24, NvOdmWakeupPadPolarity_Low},     // Wake Event 24 - gp3_pv[2] (.AP_ONKEY#)
...
static const NvOdmPinAttrib pin_config[] = {
    ...
    { NvOdmPinRegister_Ap20_PadCtrl_SDIO1CFGPADCTRL,
     ...
     // WiFi Pins (DTA, DTD) , change DTD to be pulled down,
    { NvOdmPinRegister_Ap20_PullUpDown_A,
      NVODM_QUERY_PIN_AP20_PULLUPDOWN_A(0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0) },
                         ...
                         NvU32 Instance)
{
    static const NvOdmUsbProperty Usb1Property =
    {
        ...
        20,
        NV_TRUE, //use internal phy to wake up ??
