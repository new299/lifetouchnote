       ...
       NvOdmBatteryData *pData)
{
    ...
    static NvU32 BatteryAvgTimeInterval = 0;
    NvU32 BatteryTemp = 0;
    NvU32 BattRemCap = 0; 
    static NvU32 BattLastChargeFullCap = 0;
    static NvU32 BattCriticalCap = 0;
#if BATTERY_EXTRA_INFO
    NvU16 RemCapAlarm = 0;
    ...
    if (BatteryInst == NvOdmBatteryInst_Main)
    {
           ...
           &BatteryCurrent))
        {
			...
			BatteryAvgCurrent = BatteryCurrent;
...
fail:
    NvOdmOsPrintf("[EXIT][ERROR] NvOdmBatteryGetBatteryData.\n");
    return NV_FALSE;
}
