...
static const TPS6586xPmuSupplyInfo tps6586xSupplyInfoTable[] =
{
    ...
    {
        Ext_SWITCHPmuSupply_AVDD_DSI_CSI,
    ...
    {
        Ext_SWITCHPmuSupply_VDDIO_CAMERA,
        ...
        NvU32* pMilliVolts)
{
    ...
    if ((vddRail == Ext_TPS62290PmuSupply_BUCK)      ||
        ...
        (vddRail == Ext_SWITCHPmuSupply_AVDD_DSI_CSI)||
        (vddRail == Ext_SWITCHPmuSupply_VDDIO_CAMERA))
    {
    ...
    NvBool Enable)
{
    ...
    else
    {
        ...
        case Ext_SWITCHPmuSupply_AVDD_DSI_CSI:
            GpioPort = NVODM_PORT('y');
            GpioPin  = 2;
            break;

        case Ext_SWITCHPmuSupply_VDDIO_CAMERA:
            GpioPort = NVODM_PORT('l');
            GpioPin  = 6;
            break;

        case Ext_TPS2051BPmuSupply_VDDIO_VID:
  	    WARN(1, "Ext_TPS2051BPmuSupply_VDDIO_VID no longer exist on LTNA7!!\n");
        default:
            return NV_FALSE;
        }
...
//    static TPS6586xDevice s_tps6586x = {0};
...
#if 0
        //for compass power,
        if (NV_FALSE == Tps6586xWriteVoltageReg(hDevice, TPS6586xPmuSupply_LDO6, 2850, NULL))
            NVODMPMU_PRINTF(("TPS: Fail to set the LDO6 to 2.85V\n"));
        else
            NVODMPMU_PRINTF(("TPS: set the LDO6 to 2.85V\n"));
        //end 
#endif
    }   
    else
    ...
    /* workaround for SM1 glitch */
    Tps6586xI2cWrite8(hDevice, TPS6586x_R47_SMODE1, 0x02);
