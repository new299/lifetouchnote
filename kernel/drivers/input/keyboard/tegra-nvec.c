...
#define EC_LAST_CODE 0x7E// Sam modify for ltna7
 ...
 */
//NvU8 code_tab_102us[EC_TOTAL_CODES] = { // Sam modify it for FN = 0x1d0
NvU16 code_tab_102us[EC_TOTAL_CODES] = {
	KEY_GRAVE,	// 0x00
	KEY_ESC,
	KEY_1,
	KEY_2,
...
#ifdef CONFIG_HAS_EARLYSUSPEND
static int disp_PowerState = 0; 	/* 0: on, 1: early suspend */
#endif
...
#ifdef  CONFIG_HAS_EARLYSUSPEND
		/* in early_suspend state, all key code are disabled, except KEY_POWER */
		if ( disp_PowerState ) {
			code -= EC_FIRST_CODE;
